...
yr2012_jan <-games %>% 
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in Jan 2021",
       y = "Ratio of Peak / Average")
yr2012_feb <-games %>% 
  filter(avg >= 1000) %>%
...
yr2012_mar <-games %>% 
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in March 2021",
       y = "Ratio of Peak / Average")
yr2012_apr <-games %>% 
  filter(avg >= 1000) %>%
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in Apr 2021",
       y = "Ratio of Peak / Average")
...
yr2012_may <-games %>% 
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in May 2021",
       y = "Ratio of Peak / Average")
...
yr2012_June <-games %>% 
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in Jun 2021",
       y = "Ratio of Peak / Average")
...
yr2012_Jul <-games %>% 
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in Jul 2021",
       y = "Ratio of Peak / Average")
...
yr2012_Aug <-games %>% 
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in Aug 2021",
       y = "Ratio of Peak / Average")
yr2012_Sep <-games %>% 
  filter(avg >= 1000) %>%
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in Sep 2021",
       y = "Ratio of Peak / Average")
...
yr2012_Oct <-games %>% 
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in Oct 2021",
       y = "Ratio of Peak / Average")
...
yr2012_Nov <-games %>% 
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in Nov 2021",
       y = "Ratio of Peak / Average")
...
yr2012_Dec <-games %>% 
  ...
  scale_y_log10() + 
  scale_x_log10(labels =comma) + 
  labs(x= "Average number of players in Dec 2021",
       y = "Ratio of Peak / Average")
