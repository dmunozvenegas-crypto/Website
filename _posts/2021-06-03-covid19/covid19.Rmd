...
```
 ...
 # The following question I will look into is the distribution that is female and smokes cigarettes or tabbaco. I will be using total population.
```{r}
femsmokingpopulation <- data %>% select(female_smokers:population) %>% na.omit %>% tbl_df()
